#This report has been prepared for default of loan with following parameters Age, Outstanding balance, presence of open home loan, presence of open auto loan,Dependent, Correlation between DPD for 6months, 12 Months
...
# This shows that loan holders are dense from 36 to 55 Age
...
merged_data %>% 
  ...
  theme_minimal()+
  scale_fill_manual(values = cp_2)
# This shows that default is high between 36 to 55 Age as compared to Other groups
...
# This shows that there is no vast difference between the frequency and default for presence of open home loan or not 
